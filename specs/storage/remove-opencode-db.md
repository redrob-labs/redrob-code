# Remove `packages/redrob/src/storage/db.ts`

## Goal

Remove all production usages of the legacy `packages/redrob/src/storage/db.ts` module.
...
Production imports from `packages/redrob/src/storage/db.ts` are concentrated in 22 source files:

- `packages/redrob/src/account/repo.ts`
- `packages/redrob/src/cli/cmd/db.ts`
- `packages/redrob/src/cli/cmd/import.ts`
- `packages/redrob/src/cli/cmd/stats.ts`
- `packages/redrob/src/control-plane/workspace.ts`
- `packages/redrob/src/index.ts`
- `packages/redrob/src/node.ts`
- `packages/redrob/src/permission/index.ts`
- `packages/redrob/src/project/project.ts`
- `packages/redrob/src/server/projectors.ts`
- `packages/redrob/src/server/routes/instance/httpapi/handlers/sync.ts`
- `packages/redrob/src/server/shared/fence.ts`
- `packages/redrob/src/session/message-v2.ts`
- `packages/redrob/src/session/projectors.ts`
- `packages/redrob/src/session/prompt.ts`
- `packages/redrob/src/session/session.ts`
- `packages/redrob/src/session/todo.ts`
- `packages/redrob/src/share/share-next.ts`
- `packages/redrob/src/storage/db.ts`
- `packages/redrob/src/sync/index.ts`
- `packages/redrob/src/worktree/index.ts`
...
Status: Completed. Startup, the public node export, and database CLI tooling no longer import the legacy opencode database wrapper; `packages/redrob/src/storage/db.ts` has been deleted.
...
All migration groups are complete or superseded. `packages/redrob/src/storage/db.ts` has been deleted.
...
- Existing schema ownership remains in `packages/core/src/**/*.sql.ts`; do not move table definitions back into `packages/redrob`.

## Verification Commands

- `rg "@/storage/db|./storage/db|Database\.(use|transaction|effect|Client|getPath)|\bTxOrDb\b|\bTransaction\b" packages/redrob/src`
- `bun typecheck` from `packages/redrob`
- Relevant package tests from `packages/redrob`, not the repo root
