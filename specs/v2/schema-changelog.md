...
- Canonical tagged tool file sources in `@redrob-code/llm`.
...
- Canonicalize ambient instruction traversal boundaries, honor `REDROB_DISABLE_PROJECT_CONFIG`, and make non-empty aggregate updates explicitly supersede previously loaded instructions.
