...
export const TypeId: TypeId = "~@redrob-code/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@redrob-code/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@redrob-code/effect-sqlite-node/NodeSqliteClient")
