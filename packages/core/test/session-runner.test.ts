...
import {
  ...
  type LLMClientShape,
  type LLMRequest,
} from "@redrob-code/llm"
import * as OpenAIChat from "@redrob-code/llm/protocols/openai-chat"
import { Database } from "@redrob-code/core/database/database"
import { makeLocationNode } from "@redrob-code/core/effect/app-node"
...
import { PermissionV2 } from "@redrob-code/core/permission"
import { EventTable } from "@redrob-code/core/event/sql"
import { Project } from "@redrob-code/core/project"
import { ProjectTable } from "@redrob-code/core/project/sql"
import { QuestionV2 } from "@redrob-code/core/question"
import { AbsolutePath } from "@redrob-code/core/schema"
import { SessionV2 } from "@redrob-code/core/session"
import { Snapshot } from "@redrob-code/core/snapshot"
import { ContextSnapshotDecodeError } from "@redrob-code/core/session/error"
import { SessionEvent } from "@redrob-code/core/session/event"
import { SessionInput } from "@redrob-code/core/session/input"
import { SessionMessage } from "@redrob-code/core/session/message"
import { Prompt } from "@redrob-code/core/session/prompt"
import { SessionProjector } from "@redrob-code/core/session/projector"
import { SessionExecution } from "@redrob-code/core/session/execution"
import { SessionRunCoordinator } from "@redrob-code/core/session/run-coordinator"
import { SessionRunner } from "@redrob-code/core/session/runner"
import * as SessionRunnerLLM from "@redrob-code/core/session/runner/llm"
import { SessionRunnerModel } from "@redrob-code/core/session/runner/model"
import { ToolRegistry } from "@redrob-code/core/tool/registry"
import { ApplicationTools } from "@redrob-code/core/tool/application-tools"
import { AgentV2 } from "@redrob-code/core/agent"
import { Config } from "@redrob-code/core/config"
import { ConfigCompaction } from "@redrob-code/core/config/compaction"
...
import {
  ...
  SessionMessageTable,
  SessionTable,
} from "@redrob-code/core/session/sql"
import { SessionStore } from "@redrob-code/core/session/store"
import { SystemContext } from "@redrob-code/core/system-context"
import { SystemContextRegistry } from "@redrob-code/core/system-context/registry"
import { SkillGuidance } from "@redrob-code/core/skill/guidance"
import { ReferenceGuidance } from "@redrob-code/core/reference/guidance"
