...
import { AgentAttachment, FileAttachment, Prompt, Source } from "@redrob-code/schema/prompt"
import { Provider } from "@redrob-code/schema/provider"
import { Project } from "@redrob-code/schema/project"
import { ProjectDirectories } from "@redrob-code/schema/project-directories"
import { PermissionV1 } from "@redrob-code/schema/permission-v1"
...
import { Command } from "@redrob-code/schema/command"
import { Connection } from "@redrob-code/schema/connection"
import { Credential } from "@redrob-code/schema/credential"
import { FileSystem } from "@redrob-code/schema/filesystem"
import { Integration } from "@redrob-code/schema/integration"
import { LLM } from "@redrob-code/schema/llm"
import { Permission } from "@redrob-code/schema/permission"
import { Plugin } from "@redrob-code/schema/plugin"
import { Pty } from "@redrob-code/schema/pty"
import { Reference } from "@redrob-code/schema/reference"
import { SessionTodo } from "@redrob-code/schema/session-todo"
import { Skill } from "@redrob-code/schema/skill"
import { AbsolutePath, DateTimeUtcFromMillis, optional, statics } from "@redrob-code/schema/schema"
...
test("Core reuses the canonical shared schemas", async () => {
  const [
    ...
    import("@redrob-code/core/command"),
    import("@redrob-code/core/integration/connection"),
    import("@redrob-code/core/credential"),
    import("@redrob-code/core/filesystem"),
    import("@redrob-code/core/integration"),
    import("@redrob-code/core/location"),
    import("@redrob-code/llm"),
    import("@redrob-code/core/permission"),
    import("@redrob-code/core/v1/permission"),
    import("@redrob-code/core/project/copy"),
    import("@redrob-code/core/pty"),
    import("@redrob-code/core/project/schema"),
    import("@redrob-code/core/reference"),
    import("@redrob-code/core/session/input"),
    import("@redrob-code/core/session/message"),
    import("@redrob-code/core/session/todo"),
    import("@redrob-code/core/session/prompt"),
    import("@redrob-code/core/skill"),
    import("@redrob-code/core/v2-schema"),
    import("@redrob-code/core/schema"),
    import("@redrob-code/core/workspace"),
  ])
