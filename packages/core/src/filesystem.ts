...
import { Entry, FileSystem, FindInput, Match } from "@redrob-code/schema/filesystem"
export { Entry, Match, Submatch } from "@redrob-code/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@redrob/v2/FileSystem") {}
