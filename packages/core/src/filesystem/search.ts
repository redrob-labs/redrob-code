...
export class Service extends Context.Service<Service, Interface>()("@redrob/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.REDROB_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
