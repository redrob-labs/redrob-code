...
import { FileSystemWatcher } from "@redrob-code/schema/filesystem-watcher"
...
declare const REDROB_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof REDROB_LIBC === "undefined" ? undefined : REDROB_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@redrob/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.REDROB_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.REDROB_EXPERIMENTAL_FILEWATCHER)) {
