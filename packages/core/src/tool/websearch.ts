...
import { ToolFailure } from "@redrob-code/llm"
...
export class ConfigService extends Context.Service<ConfigService, Config>()("@redrob/v2/WebSearchConfig") {}

/** Isolates the retained product environment contract from the generic tool implementation. */
export const defaultConfigLayer = Layer.sync(ConfigService, () =>
  ConfigService.of({
    provider:
      process.env.REDROB_WEBSEARCH_PROVIDER === "exa" || process.env.REDROB_WEBSEARCH_PROVIDER === "parallel"
        ? process.env.REDROB_WEBSEARCH_PROVIDER
        : undefined,
    enableExa: truthy("REDROB_EXPERIMENTAL") || truthy("REDROB_ENABLE_EXA") || truthy("REDROB_EXPERIMENTAL_EXA"),
    enableParallel: truthy("REDROB_ENABLE_PARALLEL") || truthy("REDROB_EXPERIMENTAL_PARALLEL"),
