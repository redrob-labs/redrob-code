...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@redrob-code/llm"
...
export class Service extends Context.Service<Service, Interface>()("@redrob/v2/ToolRegistry") {}
