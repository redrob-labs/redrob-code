...
export class Service extends Context.Service<Service, Interface>()("@redrob/v2/SkillDiscovery") {}
      ...
      pull: Effect.fn("SkillDiscovery.pull")(function* (url) {
        ...
        return yield* Effect.forEach(
          data.skills.flatMap((skill) => {
            ...
            const versionFile = path.join(root, ".redrob-version")
            ...
            Effect.gen(function* () {
              ...
              if (version === undefined || current === version) {
                ...
                yield* Effect.gen(function* () {
                  ...
                  if (!exists) return
                  yield* fs.writeFileString(path.join(staging, ".redrob-version"), version)
