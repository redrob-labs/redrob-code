...
import { ListAnchor } from "@redrob-code/schema/session"
...
import { SessionDurable } from "@redrob-code/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@redrob/v2/Session") {}
