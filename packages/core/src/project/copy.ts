...
import { Event } from "@redrob-code/schema/project-directories"
import { ProjectCopy } from "@redrob-code/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@redrob/ProjectCopy") {}
