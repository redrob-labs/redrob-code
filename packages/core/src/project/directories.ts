...
import type { EffectDrizzleSqlite } from "@redrob-code/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@redrob/ProjectDirectories") {}
