...
import type { Data, Definition, Payload } from "@redrob-code/schema/event"
...
import { Durable } from "@redrob-code/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@redrob-code/schema/event").ID
export type { Data, Definition, Payload } from "@redrob-code/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@redrob/Event") {}
