...
import { PermissionSaved } from "@redrob-code/schema/permission-saved"
...
export class Service extends Context.Service<Service, Interface>()("@redrob/v2/PermissionSaved") {}
