...
class Database extends Context.Service<Database, DatabaseShape>()("@redrob/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@redrob/example/UserStore") {
