...
import { isSessionNotFoundError, isUnauthorizedError, RedrobCode } from "../src"

test("exposes every standard HTTP API group", () => {
  const client = RedrobCode.make({ baseUrl: "http://localhost:3000" })
