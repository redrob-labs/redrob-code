// Generated by @redrob-code/httpapi-codegen. Do not edit.
...
type Endpoint7_0Request = Parameters<RawClient["server.variant"]["variant.paraphrase"]>[0]
type Endpoint7_0Input = {
  readonly text: Endpoint7_0Request["payload"]["text"]
  readonly models: Endpoint7_0Request["payload"]["models"]
  readonly requestId?: Endpoint7_0Request["payload"]["requestId"]
}
const Endpoint7_0 = (raw: RawClient["server.variant"]) => (input: Endpoint7_0Input) =>
  raw["variant.paraphrase"]({
    payload: { text: input["text"], models: input["models"], requestId: input["requestId"] },
  }).pipe(Effect.mapError(mapClientError))

type Endpoint7_1Request = Parameters<RawClient["server.variant"]["variant.compare"]>[0]
type Endpoint7_1Input = {
  readonly messages: Endpoint7_1Request["payload"]["messages"]
  readonly models: Endpoint7_1Request["payload"]["models"]
  readonly requestId?: Endpoint7_1Request["payload"]["requestId"]
}
const Endpoint7_1 = (raw: RawClient["server.variant"]) => (input: Endpoint7_1Input) =>
  raw["variant.compare"]({
    payload: { messages: input["messages"], models: input["models"], requestId: input["requestId"] },
  }).pipe(Effect.mapError(mapClientError))
