...
import { compile, emitEffectImported, emitPromise, write } from "@redrob-code/httpapi-codegen"
    ...
    [
      write(
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              name: "RedrobEventEncoded",
              import: 'import type { RedrobEventEncoded } from "@redrob-code/protocol/groups/event"',
            },
          },
        }),
