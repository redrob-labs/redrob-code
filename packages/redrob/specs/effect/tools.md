...
Practical reference for the current tool-migration state in `packages/redrob`.
...
Tool tests should use the existing Effect helpers in `packages/redrob/test/lib/effect.ts`:
