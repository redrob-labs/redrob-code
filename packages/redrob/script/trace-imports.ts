...
// Resolved from this script's own location rather than hardcoded. It previously
// pointed at one developer's home directory, so the tracer resolved nothing on any
// other machine.
