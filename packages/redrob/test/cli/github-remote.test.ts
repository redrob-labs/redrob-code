...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/redrob.git")).toEqual({ owner: "sst", repo: "redrob" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/redrob")).toEqual({ owner: "sst", repo: "redrob" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/redrob.git")).toEqual({ owner: "sst", repo: "redrob" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/redrob")).toEqual({ owner: "sst", repo: "redrob" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/redrob.git")).toEqual({ owner: "sst", repo: "redrob" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/redrob")).toEqual({ owner: "sst", repo: "redrob" })
})
