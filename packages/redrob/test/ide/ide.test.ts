...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders REDROB_CALLER", () => {
    process.env["REDROB_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode REDROB_CALLER", () => {
    process.env["REDROB_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown REDROB_CALLER", () => {
    process.env["REDROB_CALLER"] = "unknown"
