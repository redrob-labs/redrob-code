...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips redrob-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-redrob-directory"]).toBeUndefined()
      expect(forwarded["x-redrob-workspace"]).toBeUndefined()
