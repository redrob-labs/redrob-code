...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips redrob-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-redrob-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-redrob-directory")).toBeNull()
      expect(result.get("x-redrob-workspace")).toBeNull()
