...
import { path } from "@redrob-code/core/effect/app-node-platform"
...
import type { ProjectV2 } from "@redrob-code/core/project"
...
import { WorktreeEvent } from "@redrob-code/schema/worktree-event"
...
export class Service extends Context.Service<Service, Interface>()("@redrob/Worktree") {}
  ...
  Effect.gen(function* () {
    ...
    const candidate = Effect.fn("Worktree.candidate")(function* (input: {
      ...
      for (const attempt of Array.from({ length: MAX_NAME_ATTEMPTS }, (_, i) => i)) {
        ...
        const branch = input.detached ? undefined : `redrob/${name}`
