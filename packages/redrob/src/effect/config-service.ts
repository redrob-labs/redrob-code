 ...
 *   "@redrob/ServerAuthConfig",
 *   {
 *     password: Config.string("REDROB_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("REDROB_SERVER_USERNAME").pipe(Config.withDefault("redrob")),
 *   },
 * ) {}
 *
