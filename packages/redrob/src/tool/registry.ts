...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@redrob-code/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@redrob/ToolRegistry") {}
