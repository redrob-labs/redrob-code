...
import { SessionStatusEvent } from "@redrob-code/schema/session-status-event"
...
export class Service extends Context.Service<Service, Interface>()("@redrob/SessionStatus") {}
