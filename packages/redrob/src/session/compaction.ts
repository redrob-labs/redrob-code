...
import { buildPrompt } from "@redrob-code/core/session/compaction"
import { SessionCompactionEvent } from "@redrob-code/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@redrob/SessionCompaction") {}
