...
import { Slug } from "@redrob-code/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@redrob-code/llm"
...
import { locationServiceMapLayer } from "@redrob-code/core/location-services"
...
import { PartTable, SessionTable } from "@redrob-code/core/session/sql"
...
import { NonNegativeInt, optional } from "@redrob-code/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".redrob", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@redrob/Session") {}
