...
import { llmClient } from "@redrob-code/core/effect/app-node-platform"
...
import type { LLMEvent } from "@redrob-code/llm"
import { LLMClient } from "@redrob-code/llm/route"
import type { LLMClientService } from "@redrob-code/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@redrob/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // from the workflow service are executed via redrob's tool system
      ...
      // Runtime seam: native is an opt-in adapter over @redrob-code/llm. It
