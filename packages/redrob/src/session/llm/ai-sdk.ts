import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@redrob-code/llm"
...
// Move this extraction into @redrob-code/llm when Copilot is handled by the native runtime.
