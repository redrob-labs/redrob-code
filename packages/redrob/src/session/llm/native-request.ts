import type { JsonSchema, LLMRequest, ProviderMetadata } from "@redrob-code/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@redrob-code/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @redrob-code/llm request objects from redrob's session/AI SDK-shaped data.
  return LLM.request({
