...
import { EventSequenceTable, EventTable } from "@redrob-code/core/event/sql"
...
import { WorkspaceEvent } from "@redrob-code/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@redrob/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        REDROB_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        REDROB_WORKSPACE_ID: config.id,
        REDROB_EXPERIMENTAL_WORKSPACES: "true",
