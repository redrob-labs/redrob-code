...
import { AbsolutePath, type DeepMutable } from "@redrob-code/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@redrob/Agent") {}
          ...
          plan: {
            ...
            permission: Permission.merge(
              ...
              Permission.fromConfig({
                ...
                edit: {
                  "*": "deny",
                  [path.join(".redrob", "plans", "*.md")]: "allow",
