...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@redrob/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@redrob/ACPDirectory") {}
