...
import { ProjectDirectoryTable, ProjectTable } from "@redrob-code/core/project/sql"
import { ProjectDirectories } from "@redrob-code/core/project/directories"
...
import { which } from "@redrob-code/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@redrob/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.REDROB_FAKE_VCS)
