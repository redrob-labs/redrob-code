...
>()("@redrob/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@redrob/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.REDROB_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.REDROB_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-redrob-directory"] || process.cwd()
}
