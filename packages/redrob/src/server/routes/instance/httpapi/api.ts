...
export const RootHttpApi = HttpApi.make("redrob-root")
...
export const InstanceHttpApi = HttpApi.make("redrob-instance")
...
export const RedrobHttpApi = HttpApi.make("redrob")
