...
import { httpClient, path } from "@redrob-code/core/effect/app-node-platform"
...
export class Service extends Context.Service<Service, Interface>()("@redrob/SkillDiscovery") {}
