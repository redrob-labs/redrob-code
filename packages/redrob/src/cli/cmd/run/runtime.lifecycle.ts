...
import { openEditor } from "@redrob-code/tui/editor"
import { registerRedrobKeymap } from "@redrob-code/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerRedrobKeymap(keymap, renderer, input.tuiConfig)
