...
import { normalizePromptContent } from "@redrob-code/tui/editor"
...
import { REDROB_BASE_MODE, useBindings } from "@redrob-code/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close RedrobCode" } satisfies SlashOption,
    ]
