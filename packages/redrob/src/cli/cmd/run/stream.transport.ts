...
import type { Event, GlobalEvent, RedrobClient } from "@redrob-labs/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@redrob/RunStreamTransport") {}
