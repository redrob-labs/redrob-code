...
//
// The saved variant persists across sessions in ~/.local/state/redrob/model.json
...
class Service extends Context.Service<Service, VariantService>()("@redrob/RunVariant") {}
