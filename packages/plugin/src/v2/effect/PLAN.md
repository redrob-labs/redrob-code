...
- Effect plugins import `@redrob-code/plugin/v2/effect`, not `@redrob-code/core`.
- Public domain values use generated `@redrob-code/sdk` types.
...
- Define `PluginHost` domain capabilities in `@redrob-code/plugin/v2/effect`.
