...
{
  "dependencies": {
    "@redrob-code/codemode": "workspace:*"
  }
}
```
...
```ts
import { CodeMode, Tool } from "@redrob-code/codemode"
...
```ts
import { CodeMode, OpenAPI } from "@redrob-code/codemode"
...
```ts
import { toolError } from "@redrob-code/codemode"
