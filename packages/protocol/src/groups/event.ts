...
import type { Definition } from "@redrob-code/schema/event"
...
export const RedrobEvent = event.schema
export type RedrobEvent = typeof RedrobEvent.Type
export type RedrobEventEncoded = typeof RedrobEvent.Encoded
