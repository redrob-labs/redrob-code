import { RedrobCode } from "@redrob-code/client/effect"
...
import { createEmbeddedRoutes } from "@redrob-code/server/routes"
import { Context, Effect, Layer, Scope } from "effect"
import { FetchHttpClient, HttpRouter, HttpServer } from "effect/unstable/http"

export const create = Effect.fn("RedrobCode.create")(function* () {
  ...
  const client = yield* RedrobCode.make({ baseUrl: "http://redrob.local" }).pipe(
...
export class Service extends Context.Service<Service, Interface>()("@redrob-code/sdk-next/RedrobCode") {}
