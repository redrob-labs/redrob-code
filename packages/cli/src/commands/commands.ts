...
declare const REDROB_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof REDROB_CLI_NAME === "string" ? REDROB_CLI_NAME : "redrob", {
  description: "Redrob Code 2.0 preview command line interface",
  commands: [
    Spec.make("api", {
