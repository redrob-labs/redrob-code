...
Schema-first LLM core for Redrob Code. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@redrob-code/llm"
import { OpenAI } from "@redrob-code/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@redrob-code/llm/providers"
