...
> current private `@redrob-code/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@redrob-code/ai`
...
import { LLM } from "@redrob-code/ai"
import { OpenAI } from "@redrob-code/ai/providers/openai"
...
```ts
import { Message } from "@redrob-code/ai"
...
import { LLM, Tool } from "@redrob-code/ai"
...
```ts
import { LLM } from "@redrob-code/ai/promise"
import { OpenAI } from "@redrob-code/ai/providers/openai"
...
```ts
import { LLMSchema } from "@redrob-code/ai/schema"
...
```ts
import { Provider, Protocol } from "@redrob-code/ai/provider"
...
@redrob-code/ai/promise
  Promise/AsyncIterable LLM facade

@redrob-code/ai/schema
  serializable domain schemas

@redrob-code/ai/provider
  experimental Provider and Protocol authoring APIs

@redrob-code/ai/providers/openai
@redrob-code/ai/providers/anthropic
@redrob-code/ai/providers/google
...
```
...
| Current                                 | Proposed                                                    |
| --------------------------------------- | ----------------------------------------------------------- |
| `@redrob-code/llm`                      | `@redrob-code/ai`                                           |
